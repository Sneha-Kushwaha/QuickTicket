...
const AddShows = () => {
  ...
  const [dateTimeInput, setsDateTimeInput] = useState("");
  const [showPrice, setShowsPrice] = useState("");
          ...
          {nowPlayingMovies.map((movie) => (
            <div key={movie.id} className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300 `}>
              <div className="relative rounded-lg overflow-hidden">
                ...
                <div className="text-sm flex items-center justify-between p-2 bg-block/70 w-full absolute bottom-0 left-0">
